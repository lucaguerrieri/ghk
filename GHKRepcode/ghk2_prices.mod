...
// 14 - 17
d_eh = (1-delta_eh)*k_eh(-1) + z_eh(-1)*j_eh(-1) * (1 -nu_eh/2*(j_eh(-1)/jB1_eh(-1) -1 )^2 ); 
d_el = (1-delta_el)*k_el(-1) + z_el(-1)*j_el(-1) * (1 -nu_el/2*(j_el(-1)/jB1_el(-1) -1 )^2 );
d_sh = (1-delta_sh)*k_sh(-1) + z_sh(-1)*j_sh(-1) * (1 -nu_sh/2*(j_sh(-1)/jB1_sh(-1) -1 )^2 );
d_sl = (1-delta_sl)*k_sl(-1) + z_sl(-1)*j_sl(-1) * (1 -nu_sl/2*(j_sl(-1)/jB1_sl(-1) -1 )^2 ); 
...
// 38 - 41
lambda_je = lambda_deh(1)* beta * z_eh *( 1- nu_eh/2* (j_eh/j_eh(-1)-1)^2 - j_eh*nu_eh*(j_eh/j_eh(-1)-1)/j_eh(-1) )
            + lambdaF1_deh(1)*beta^2 * z_eh(1)*j_eh(1)*nu_eh*(j_eh(1)/j_eh-1)*j_eh(1)/j_eh^2;

lambda_je = lambda_del(1)* beta * z_el *( 1- nu_el/2* (j_el/j_el(-1)-1)^2 - j_el*nu_el*(j_el/j_el(-1)-1)/j_el(-1) )
            + lambdaF1_del(1)*beta^2 * z_el(1)*j_el(1)*nu_el*(j_el(1)/j_el-1)*j_el(1)/j_el^2;
