...
line1 = 100*scale1*[f1_k_sl_irf(1:nnperiods)/f1_k_sl, f1_k_sh_irf(1:nnperiods)/f1_k_sh,...
               ...
               f1_y_l_irf(1:nnperiods)/f1_y_l,   f1_y_h_irf(1:nnperiods)/f1_y_h   ];
...
titlelist = char('Output, CP (over a long horizon)','Output, CP (medium-run horizon)',...
                 'Consumption, CP','Agg. Investment, CP',...
                 'Wealth effect on Consumption','L Sector Output (quality adjusted)',...
                 'Substitution effect on Consumption','H Sector Output (quality adjusted)');
...
titlelist = char('Output, CP (over a long horizon)','Output, CP (medium-run horizon)',...
                 'Consumption, CP','Agg. Investment, CP',...
                 'Wealth effect on Consumption','N Sector Output (share of aggregate)',...
                 'Substitution effect on Consumption','M Sector Output (share of aggregate)');
...
first_line = 100*scale1*[f1_y_cp_irf/f1_y_cp, f1_y_cp_irf/f1_y_cp,...
                  f1_c_cp_irf/f1_c_cp, f1_j_cp_irf/f1_j_cp,...
                  f1_wec_irf, f1_y_cp_share_l_irf,...
                  f1_sec_irf, f1_y_cp_share_h_irf];
              
second_line = 100*scale2*[f2_y_cp_irf/f2_y_cp, f2_y_cp_irf/f2_y_cp,...
                   f2_c_cp_irf/f2_c_cp, f2_j_cp_irf/f2_j_cp,...
                   f2_wec_irf, f2_y_cp_share_l_irf,...
                   f2_sec_irf, f2_y_cp_share_h_irf];
third_line = [];
