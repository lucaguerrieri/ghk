...
model. Notably, expansionary productivity shocks boost consumption in every period, while expansionary efficiency shocks cause consumption to fall substantially for many periods.}
...
investment ($\nu _{0i}^{S}$ and $\nu _{0i}^{E}$) are set to 4. Adjustment
...
Margins from the IO Tables. Most of the industries whose output is used in ``Equipment and Software''
produce exclusively for ``Equipment and
Software.''
The second component of our machinery sector comprises those inputs for consumption assembly from all the industries that produce inputs used in both the NIPA definition of ``Equipment and Software'' Investment and of ``Consumption.'' These IO Table industries are: (334) Computer and Electronic
...
$\nu^E_0$ = 4 & M, N Equipment Investment & $\nu^S_0 = 4 $ & M,N Structures Investment \\
